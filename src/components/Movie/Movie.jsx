...
export default function Movie(props) {
    ...
    return (
        <div className="mr-2 h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
            <div style={{background:`url(${phim.hinhAnh}), url(https://picsum.photos/1000/200)`,backgroundPosition:'center',backgroundSize:'100%,100%'}}>
                <img className='opacity-0 w-full' style={{height:320}} src={phim.hinhAnh}/>
            </div>
